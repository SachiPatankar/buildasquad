...
//     // Update local store to clear unread count for this chat
//     const updateChatUnread = useNotificationStore.getState().updateChatUnread;
//     updateChatUnread(chatId, 0);
    
//     // ... rest of your socket setup code
//   }, [chatId, client, markMessagesAsRead]);
  
//   // Also add this to handle incoming messages in the same chat:
//   sock.on('receiveMessage', (msg: any) => {
//     if (msg.chat_id === chatId) {
//       updateCache(msg, 'add');
//       // Since we're viewing this chat, mark as read immediately
//       markMessagesAsRead({ variables: { chatId } });
//     }
//   });
